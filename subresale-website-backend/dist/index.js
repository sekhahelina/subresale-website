...
dotenv_1.default.config(); // ⬅️ Завантаження env обов'язково на початку
...
const subscriptionsRoute_1 = tslib_1.__importDefault(require("./routes/subscriptionsRoute"));
...
app.use('/subscriptions', subscriptionsRoute_1.default); // <- додано
app.get('/', (req, res) => {
